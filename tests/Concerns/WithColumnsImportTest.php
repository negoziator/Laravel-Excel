...
final class WithColumnsImportTest extends TestCase
{
    /**
    ...
    public function test_can_import_from_columns_to_model(): void
    {
        $import = new class implements ToModel, WithColumns
        {
            ...
            {
                return [
                    Text::make('name', fn (string $name): string => 'Mapped ' . $name),
                    Text::make('email'),
                ];
            }
        };
    ...
    public function test_can_import_from_columns_to_array(): void
    {
        $import = new class implements ToArray, WithColumns
        {
            ...
            public function columns(): array
            {
                return [
                    ...
                    'N' => Image::make('logo', function (ImageContent $image): string {
                        Assert::assertSame('jpg', $image->extension());
    ...
    public function test_can_import_from_columns_with_heading_row(): void
    {
